# 00 — Project Origin: Download Organizer → FileManager → Agentic Upgrade

> The honest backstory. No rewriting history — the projects speak for themselves.

## 1. The Idea — "Download Organizer"
...
## 3. The Interlude — Agentic Patterns from a Hackathon Project
...
## 4. The Upgrade — "Agentic FileManager"
